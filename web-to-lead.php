				...
				array(
					...
					"fields" => array(
						...
						array(
							...
							"type"    => "text",
							"class"   => "medium code",
							"tooltip" => sprintf(__("To find your Salesforce.com Organization ID, in your Salesforce.com account, go to [Your Name] &raquo; Setup &raquo; Company Profile (near the bottom of the left sidebar) &raquo; Company Information. It will look like %s", 'gravity-forms-salesforce'), '<code>XXXXXXXXXX</code>')
						),
						array(
							"name"    => "date_format",
